...
struct mudclient {
    char rsa_exponent[512];  // RSA public key exponent
    char rsa_modulus[512];   // RSA public key modulus
    size_t rsa_exponent_len; // Add this field for the exponent length
    size_t rsa_modulus_len;  // Add this field for the modulus length
#ifdef WII
